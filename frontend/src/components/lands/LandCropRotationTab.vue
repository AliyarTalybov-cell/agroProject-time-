        ...
        <div v-if="items.length" class="lands-list-plain">
          <div v-for="rotation in items" :key="rotation.id" class="lands-list-plain-item lands-list-plain-item--stack">
            ...
            <div class="lands-item-actions">
              <Button variant="ghost" size="icon-sm" type="button" class="lands-action-btn lands-action-btn--edit" aria-label="Редактировать" title="Редактировать" @click="$emit('edit', rotation)">
                <PencilIcon :size="18" />
              </Button>
